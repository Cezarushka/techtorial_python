...
str = ' Python is great.'
#  012345678910111213
# What is the index of letter n ? 
#index of letter n will be 6
# What is the syntax for getting the charachter from index 6
str[6] #-> this will give me the 7th letter from the str.
#What is the index of .? will be 16
str[16] # -> "."
